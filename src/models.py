...
class Encoder(nn.Module):
    def __init__(self, input_dim, embedding_dim, dropout_rates, dims_layers, swap_noise_ratio):
        ...
        layers.append(nn.Linear(input_dim, dims_layers[0]))
        ...
        layers.append(nn.Linear(dims_layers[-1], embedding_dim))
